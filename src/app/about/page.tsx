    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="bg-accent rounded-[80px] mx-4 md:mx-8 mt-8 p-12 md:p-16 text-center">
        ...
        <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto">
          Empowering your fitness journey with cutting-edge technology and
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mb-20">
          ...
          <div className="bg-[#222222] rounded-[60px] p-12">
            <p className="text-gray-300 text-lg leading-relaxed mb-6">
              JYM Fitness was born from a simple yet powerful idea: everyone
              deserves access to personalized, effective fitness guidance. We
              understand that starting a fitness journey can be overwhelming,
              with countless workout plans, conflicting nutrition advice, and a
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#222222] rounded-[40px] p-8 text-center hover:bg-[#2a2a2a] transition-colors">
              ...
              <p className="text-gray-400">
                Fitness is for everyone. We create solutions that work for all
                fitness levels, body types, and backgrounds.
              </p>
            </div>
            ...
            <div className="bg-[#222222] rounded-[40px] p-8 text-center hover:bg-[#2a2a2a] transition-colors">
              ...
              <p className="text-gray-400">
                We empower our users with knowledge, tools, and support to take
                control of their fitness journey.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Our revolutionary AI technology analyzes your meals through
                    photos, providing accurate nutritional information
                    instantly. No more manual tracking or guesswork.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-black rounded-[40px] p-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Every workout and meal plan is tailored to your specific
                    goals, fitness level, and preferences. Your journey is
            ...
            <div className="bg-black rounded-[40px] p-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Access to over 800 exercises with detailed instructions,
                    videos, and form guidance. Never run out of workout ideas.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-black rounded-[40px] p-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Join thousands of fitness enthusiasts. Share your progress,
                    get motivated, and celebrate achievements together.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-[#222222] rounded-[80px] p-12 md:p-16 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="text-6xl font-black text-[#e0fe10] mb-3">
                10K+
              </div>
