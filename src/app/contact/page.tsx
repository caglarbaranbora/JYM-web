  ...
  return (
    <div className="min-h-screen bg-black text-white relative max-w-8xl p-8 overflow-hidden">
      <AnimatedSection delay={0.1} direction="left">
        <Link
          href="/"
          className="flex items-center gap-2 px-6 py-3 bg-[#222222] hover:bg-[#333333] transition-colors rounded-full w-fit"
        >
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-400 text-lg leading-relaxed">
                  Whether you have a question about features, pricing, need a demo, or anything else, our team is ready
                ...
                <div className="bg-[#222222] rounded-3xl p-6 hover:bg-[#2a2a2a] transition-colors">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:contact.jymfitness@gmail.com" className="text-[#e0fe10] hover:underline">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {submitMessage && (
                  <div className="bg-[#e0fe10]/20 border border-[#e0fe10] rounded-2xl p-4">
                    <p className="text-[#e0fe10] text-center font-medium">{submitMessage}</p>
                  </div>
                )}
              </form>
            </div>
